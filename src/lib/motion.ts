...
export const duration = {
  ...
  categoryChange: 0.45,
  /** Crossfade der rotierenden Gerichte-Fotos in der Cucina-Sektion. */
  dishRotation: 1.2,
} as const;
...
/**
 * Abstand zwischen zwei Bildwechseln der Cucina-Rotation, in Millisekunden.
 * Pro Tick wechselt genau ein Slot; bei drei Slots steht jedes Bild damit
 * rund dreimal so lange, und es ist nie mehr als ein Wechsel gleichzeitig
 * im Bild.
 */
